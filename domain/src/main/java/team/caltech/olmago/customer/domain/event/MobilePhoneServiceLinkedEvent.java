...
public class MobilePhoneServiceLinkedEvent extends CustomerEventBase  {
  ...
  @Builder
  public MobilePhoneServiceLinkedEvent(long customerId, LocalDateTime linkedDtm, long mobilePhoneSvcMgmtNum, String mobilePhoneNumber, String mobilePhonePricePlan, List<String> dcTargetUzooPassProductCodes) {
